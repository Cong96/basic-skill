    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (message.getMessageType() == Constants.MESSAGE_TYPE_RESPONSE) {
            ...
            if (request.getRequestType() == Constants.REQUEST_TYPE_PUSH_MESSAGE) {
                ...
                String senderNickName = messagePushRequest.getSenderNickname();
                String senderPortraitUrl = messagePushRequest.getSenderPortraitUrl();
                System.out.println("发送者nickName:{}" + senderNickName);
                System.out.println("发送者nickName:{}" + senderPortraitUrl);
