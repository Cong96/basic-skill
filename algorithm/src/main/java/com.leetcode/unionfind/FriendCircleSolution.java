...
/**
 * @ClassName FriendCircleSolution
 * @Description
 * @Author BryantCong
...
public class FriendCircleSolution {
    ...
    public static void main(String[] args) {
       // int[][] friends=new int[][]{{1,1,0},{1,1,1},{0,1,1}};
        ...
        FriendCircleSolution friendCircleSolution=new FriendCircleSolution();
        int result= friendCircleSolution.findCircleNum(friends);
    ...
    public void initUnionFind(int[][] friends){
    ...
    public int findCircleNum(int[][] friends) {
        ...
        initUnionFind(friends);
        for(int row=0;row<n-1;row++){
            for(int clo=row;clo<n;clo++){
                if(friends[row][clo]==1){
                    union(row,clo);
                }
            }
        }
