...
public class LongsetSubStringSolution {
    public static void main(String[] args) {
        ...
        LongsetSubStringSolution substringSolution = new LongsetSubStringSolution();

        System.out.println(substringSolution.longestSubString(s));
    }
    ...
    public String longestSubString(String str) {
        ...
        return str.substring(start,longestLength);
    }
}
